...
Also, having a line graph demonstrating the average donation compared to distance from the venue would help focus the campaign to a certain area rather than having it spread to a point where potential supporters will not consider donating because it is simply too far out of their way.
